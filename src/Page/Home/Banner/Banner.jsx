...
const Banner = () => {
  const settings = {
    ...
    return (
      ...
      <h3 className='text-center text-white font-medium text-7xl w-11/12 mx-auto'>Our Digital Solutions Are the Key to Making Your Dreams Come True</h3>
      ...
      <div className="banner-title left-0 absolute top-1/3 w-full">
      <h3 className='text-center text-white font-medium text-8xl'>Apps Development <br /> Android and iOS</h3>
      ...
      <div className="banner-title left-0 absolute top-1/3 w-full">
      <h3 className='text-center text-white font-medium text-8xl'>Web Development</h3>
      ...
      <div className="banner-title left-0 absolute top-1/3 w-full">
      <h3 className='text-center text-white font-medium text-8xl'>Digital Marketing</h3>
      ...
      <div className="banner-title left-0 absolute top-1/3 w-full">
      <h3 className='text-center text-white font-medium text-8xl'>UI / UX Design</h3>
