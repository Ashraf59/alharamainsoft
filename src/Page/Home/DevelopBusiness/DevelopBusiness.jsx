...
const DevelopBusiness = () => {
    return (
     ...
     data-aos-easing="ease-in-sine" data-aos-duration="1000">
            ...
            <p className="py-6 text-base md:text-xl lg:text-xl text-gray-500"> Drive innovation with elite tech teams. Experience excellence as we connect you with a dedicated remote workforce of exceptional freelance talent, tailored to meet all your software development requirements.</p>
          </div>
